...
<body>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                <li><strong>Categorie</strong>: Application Lourde </li>
                <li><strong>Client</strong>: GSB</li>
            ...
            <div class="portfolio-description">
              ...
              <p>
                Le project est une application lourde qui a pour but de faire les compte rendu dss visite  
              </p>
            </div>
          </div>
  ...
  <!-- Vendor JS Files -->
  <script src="../styles/vendor/purecounter/purecounter.js"></script>
  ...
  <script src="../styles/vendor/typed.js/typed.min.js"></script>
