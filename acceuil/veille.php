...
<head>
    ...
    <link rel="stylesheet" href="./styles/veille.css">
  ...
  <div class="container">
    ...
    <li class="nav-item">
      ...
      <li class="nav-item dropdown">
            <a  class="nav-link dropdown-toggle" data-bs-toggle="dropdown" role="button" aria-expanded="false">Mon Profile</a>
      ...
      <li class="nav-item">
        <a class="nav-link " href="#" tabindex="-1" aria-disabled="true">Ma veille</a>
      </li>
    </ul>
...
<main class="veille">
  <h1>Ma veille se porte sur l'evolution des language de developpement</h1>
<p><h6> Monde de l'informatique toujours en évolution depuis l'apparition des outils informatiques il y a plus d'un demi-siècle sur les langages de progrmation </h6></p>
<p>Voici le classement actuelle des 8 langages les plus utilisé</p>
<div class="language">
  <ol>
    <li>Java</li>
    <p>
      <img src="image/language/Java.jpg" alt=""  width="700" height="324">
      Depuis sa création au milieu des années 90, 
    </p>
    <li>Python</li>
    <p>
...
<a href="https://www.codeur.com/blog/top-langages-de-programmation/">Référence</a>
</main>
<footer>
